...
namespace CRUD_EF_CodeFirst.Controllers
{
    ...
    {
        private readonly CRUD_EF_CodeFirstContext _context;

        public StudentsController(CRUD_EF_CodeFirstContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CRUD_EF_CodeFirstContext.Student'  is null.");
            }
            var student = await _context.Student.FindAsync(id);
            if (student != null)
            {
